...
![alt text](assets/f3/minimal-to-canonical-sop-overview.png)

**you js gotta add the missing terms from the equation as (X+X') and multiply it thats it lwk**

![alt text](assets/f3/minimal-to-canonical-sop-distribution.png)
...
![alt text](assets/f3/minimal-to-canonical-pos-distribution.png)
